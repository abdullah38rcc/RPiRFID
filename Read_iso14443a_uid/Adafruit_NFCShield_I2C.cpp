...
void Adafruit_NFCShield_I2C::wiresendcommand(uint8_t* cmd, uint8_t cmdlen) {
...
#ifdef PN532DEBUG
  Serial.print("PREAMBLE 0x"); Serial.print(PN532_PREAMBLE, HEX);
  Serial.print(" PREAMBLE 0x"); Serial.print(PN532_PREAMBLE, HEX);
  Serial.print(" STARTCODE2 0x"); Serial.print(PN532_STARTCODE2, HEX);
  Serial.print(" cmdlen 0x"); Serial.print(cmdlen, HEX);
  Serial.print(" ~cmdlen+1 0x"); Serial.print(~cmdlen + 1, HEX);
  Serial.print(" HOSTTOPN532 0x"); Serial.print(PN532_HOSTTOPN532, HEX);
#endif
  ...
  for (uint8_t i=0; i<cmdlen-1; i++) {
   ...
   checksum += cmd[i];
#ifdef PN532DEBUG
   Serial.print(" cmd 0x"); Serial.print(cmd[i], 1);
#endif
  }
...
#ifdef PN532DEBUG
  Serial.print(" ~checksum 0x"); Serial.print(~checksum, 1);
  Serial.print(" POSTAMBLE 0x"); Serial.print(PN532_POSTAMBLE, 1);
  Serial.println();
#endif  
